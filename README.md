...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/mdurl-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14784&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/mdurl-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `mdurl` can be installed with:

```
conda install mdurl
```

It is possible to list all of the versions of `mdurl` available on your platform with:
